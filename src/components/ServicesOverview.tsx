      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <Link to="/gems" className="group">
            <div className="bg-white shadow-lg p-8 hover:shadow-xl transition-all duration-300 border hover:border-luxury-gold h-full">
              <div className="text-center space-y-6 flex flex-col h-full">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-luxury-gold bg-opacity-10 mx-auto">
                  <Gem className="w-8 h-8 text-luxury-gold" />
                </div>
                <h3 className="luxury-heading text-2xl">Precious Gems</h3>
                <p className="luxury-text flex-grow">
                ...
                <button className="luxury-button-outline mt-auto">
                  Explore Gems
                </button>
              </div>
            </div>
